...
const COIN_LIST = [
  {id:'bitcoin',sym:'BTC',name:'Bitcoin',icon:'₿'},{id:'ethereum',sym:'ETH',name:'Ethereum',icon:'Ξ'},
  {id:'ripple',sym:'XRP',name:'Ripple XRP',icon:'✕'},{id:'solana',sym:'SOL',name:'Solana',icon:'◎'},
  {id:'binancecoin',sym:'BNB',name:'BNB',icon:'🟡'},{id:'cardano',sym:'ADA',name:'Cardano',icon:'◈'},
  {id:'dogecoin',sym:'DOGE',name:'Dogecoin',icon:'🐕'},{id:'polkadot',sym:'DOT',name:'Polkadot',icon:'●'},
  {id:'avalanche-2',sym:'AVAX',name:'Avalanche',icon:'🔺'},{id:'chainlink',sym:'LINK',name:'Chainlink',icon:'🔗'},
  {id:'litecoin',sym:'LTC',name:'Litecoin',icon:'Ł'},{id:'uniswap',sym:'UNI',name:'Uniswap',icon:'🦄'},
  {id:'tron',sym:'TRX',name:'TRON',icon:'⚙'},{id:'stellar',sym:'XLM',name:'Stellar',icon:'✦'},
  {id:'matic-network',sym:'MATIC',name:'Polygon',icon:'🟣'},{id:'shiba-inu',sym:'SHIB',name:'Shiba Inu',icon:'🐕‍🦺'},
  {id:'the-open-network',sym:'TON',name:'Toncoin',icon:'💎'},{id:'sui',sym:'SUI',name:'Sui',icon:'💧'},
  {id:'pepe',sym:'PEPE',name:'Pepe',icon:'🐸'},{id:'near',sym:'NEAR',name:'NEAR Protocol',icon:'🌐'},
];
